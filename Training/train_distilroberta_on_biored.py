...
# Filter the text instances that contain 2 occurrences of '@GeneOrGeneProduct$'
...
# Load DistilRoBERTa tokenizer to preprocess the text
...
# Load DistilRoBERTa with AutoModelForSequenceClassification along with the number of expected labels, and the label mappings
